...
//   requestDetails({this.data, this.message, this.status});
...
//   String? createdAt;
//   String? updatedAt;
//   List<RequestProducts1>? requestProducts;
//   Branch? branch;
//   RequestBy? requestBy;
...
//       requestProducts = <RequestProducts1>[];
//       json['request_products'].forEach((v) {
//         requestProducts!.add(new RequestProducts1.fromJson(v));
//       });
//     }
//     branch =
...
//       this.createdAt,
//       this.updatedAt,
//       this.products, required name, required quantity});

//   RequestProducts1.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['request_products'] != null) {
      ...
      json['request_products'].forEach((v) {
        requestProducts!.add(new RequestProduct.fromJson(v));
      });
    }
    branch =
        json['branch'] != null ? new Branch.fromJson(json['branch']) : null;
